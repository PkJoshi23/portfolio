...
const PROJECTS = [
  {
    id: 1, tag: "ML · Healthcare", color: "#7C3AED",
    bg: "from-violet-950 to-purple-900",
    title: "AI Pain Detection Platform",
    desc: "AI-powered remote patient monitoring platform enabling healthcare professionals to detect and assess pain levels without in-person visits.",
    tech: ["Python", "Flask", "CV"],
    href: "https://github.com/missingpizaslice/FYPJ",
    icon: "🧠",
  },
  {
    id: 2, tag: "Analysis · PowerBI", color: "#059669",
    bg: "from-emerald-950 to-teal-900",
    title: "AWC Data Journalism Dashboard",
    desc: "KPI dashboards with slicers, filters, and drill-down features turning AWC's raw operational data into actionable business intelligence.",
    tech: ["PowerBI", "SQL", "DAX"],
    href: "https://github.com/PkJoshi23/AWC_Data_Journalism_Project",
    icon: "📊",
  },
  {
    id: 3, tag: "ML · NLP", color: "#7C3AED",
    bg: "from-violet-950 to-indigo-900",
    title: "Genre Classification via Reviews",
    desc: "NLP models that classify media genres from user-written reviews, powering a recommendation engine for a streaming platform.",
    tech: ["Python", "NLTK", "sklearn"],
    href: "https://github.com/PkJoshi23/Text_and_Social_Analytics",
    icon: "🔤",
  },
  {
    id: 4, tag: "ML · Big Data", color: "#2563EB",
    bg: "from-blue-950 to-sky-900",
    title: "American Airlines Revenue Analysis",
    desc: "Applied ML techniques to airline revenue decline data, uncovering strategies and recovery levers through predictive modelling.",
    tech: ["Python", "Pandas", "Spark"],
    href: "https://github.com/PkJoshi23/Big_Data_Management_Project",
    icon: "✈️",
  },
  {
    id: 5, tag: "Analysis · PowerBI", color: "#059669",
    bg: "from-emerald-950 to-green-900",
    title: "Singapore Livability Insights",
    desc: "PowerBI dashboard evaluating Singapore's livability and workability across 5 key dimensions for data-driven urban policy decisions.",
    tech: ["PowerBI", "Tableau", "Python"],
    href: "https://github.com/PkJoshi23/Visual_Analytics_Project",
    icon: "🏙️",
  },
  {
    id: 6, tag: "ML · Predictive", color: "#7C3AED",
    bg: "from-purple-950 to-fuchsia-900",
    title: "Startup Success Predictor",
    desc: "ML classification models predicting startup success or failure, helping venture capitalists make smarter early-stage investment decisions.",
    tech: ["Python", "XGBoost", "Pandas"],
    href: "https://github.com/PkJoshi23/Predictive_Analytics_Project",
    icon: "🚀",
  },
];
      ...
      <div style={{ display: "flex", gap: 32, alignItems: "center" }}>
        {links.map(l => (
          <a key={l} href={`#${l}`} style={{
            fontSize: 13, fontWeight: 500, color: active === l ? "#fff" : "rgba(255,255,255,0.45)",
  ...
  useEffect(() => {
    ...
    const iv = setInterval(() => {
      if (adding) {
        ...
        i++;
        if (i >= current.length) { adding = false; setTimeout(() => {}, 900); }
      } else {
        setTyped(current.slice(0, i - 1));
        i--;
        if (i <= 0) {
  ...
  return (
    <section id="hero" style={{
      ...
      <div style={{ maxWidth: 900, position: "relative", zIndex: 2 }}>
        <FadeIn delay={0}>
          <div style={{
            ...
            <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#a78bfa", display: "inline-block",
              boxShadow: "0 0 8px #a78bfa", animation: "blink 2s infinite" }}/>
            <span style={{ fontSize: 12, color: "#c4b5fd", fontFamily: "monospace", letterSpacing: "0.1em" }}>
        ...
        <FadeIn delay={100}>
          <h1 style={{
            fontSize: "clamp(3.5rem, 9vw, 7.5rem)", fontWeight: 900, lineHeight: 0.92,
        ...
        <FadeIn delay={200}>
          <div style={{ fontSize: "clamp(1.1rem, 2.5vw, 1.5rem)", color: "rgba(255,255,255,0.5)", marginBottom: 48, fontWeight: 300 }}>
            <span style={{ color: "rgba(255,255,255,0.85)", fontWeight: 500 }}>{typed}</span>
            <span style={{ animation: "blink 1s infinite", color: "#a78bfa" }}>|</span>
            <span style={{ marginLeft: 8 }}>— turning raw data into real decisions</span>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={300}>
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 80 }}>
            <a href="#projects" style={{
              ...
              onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 0 48px rgba(124,58,237,0.6)"; }}
              onMouseLeave={e => { e.currentTarget.style.transform = ""; e.currentTarget.style.boxShadow = "0 0 32px rgba(124,58,237,0.4)"; }}>
              View Projects
            </a>
            <a href="#contact" style={{
              display: "inline-flex", alignItems: "center", gap: 8,
              padding: "13px 28px", borderRadius: 8, fontWeight: 500, fontSize: 14,
        ...
        <FadeIn delay={400}>
          <div style={{ display: "flex", gap: 0, flexWrap: "wrap" }}>
            {[
              ...
              <div key={i} style={{
                padding: "20px 36px", borderRight: i < 2 ? "1px solid rgba(255,255,255,0.08)" : "none",
              }}>
                <div style={{ fontSize: "clamp(1.8rem, 3vw, 2.4rem)", fontWeight: 800, color: "#fff", letterSpacing: "-0.03em", lineHeight: 1 }}>
                  <AnimNum target={s.n} suffix={s.suf} />
                </div>
                <div style={{ fontSize: 12, color: "rgba(255,255,255,0.35)", marginTop: 4, fontFamily: "monospace", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                  {s.label}
                </div>
              </div>
            ))}
      ...
      <div style={{
        ...
        opacity: 0.35, animation: "float2 2s ease-in-out infinite",
      }}>
...
function About() {
  return (
    <section id="about" style={{ padding: "120px 5vw", position: "relative" }}>
      <div style={{
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }}>
        <FadeIn>
          ...
          <h2 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 800, letterSpacing: "-0.03em", lineHeight: 1.05, color: "#fff", marginBottom: 32 }}>
            Building things that<br/>
            <span style={{ color: "#a78bfa" }}>make data useful</span>
          </h2>
          <p style={{ fontSize: "1.05rem", color: "rgba(255,255,255,0.55)", lineHeight: 1.8, marginBottom: 20, fontWeight: 300 }}>
          ...
          <p style={{ fontSize: "1.05rem", color: "rgba(255,255,255,0.55)", lineHeight: 1.8, fontWeight: 300 }}>
          ...
          <div>
            {[
              ...
              <div key={i} style={{
                ...
                <span style={{ fontFamily: "monospace", fontSize: 12, color: "rgba(255,255,255,0.25)", minWidth: 36, paddingTop: 3 }}>
                  {item.year}
                </span>
                <div style={{
                  width: 8, height: 8, borderRadius: "50%", background: item.dot,
                  marginTop: 6, flexShrink: 0,
                  boxShadow: i < 2 ? `0 0 10px ${item.dot}` : "none",
                }}/>
                <div>
                  <div style={{ fontSize: "0.95rem", fontWeight: 600, color: "#fff", marginBottom: 2 }}>{item.role}</div>
                  <div style={{ fontSize: "0.85rem", color: "rgba(255,255,255,0.35)" }}>{item.org}</div>
                </div>
              </div>
            ))}
          </div>
    ...
    <section id="skills" style={{ padding: "120px 5vw" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <FadeIn>
          ...
          <h2 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 800, letterSpacing: "-0.03em", color: "#fff", marginBottom: 56 }}>
            What I work with
          </h2>
        </FadeIn>
          ...
          {SKILLS.map((grp, gi) => (
            <FadeIn key={gi} delay={gi * 80}>
              <div style={{
                ...
                <div style={{ fontSize: 11, fontFamily: "monospace", color: "rgba(255,255,255,0.3)", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 20 }}>
                  {grp.cat}
                </div>
                <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 10 }}>
                  {grp.items.map((item, ii) => (
                    <li key={ii} style={{ fontSize: "0.9rem", color: "rgba(255,255,255,0.7)", display: "flex", alignItems: "center", gap: 10 }}>
...
function ProjectCard({ p, i }) {
  ...
  return (
    <FadeIn delay={i * 80}>
      <a href={p.href} target="_blank" style={{ textDecoration: "none", display: "block" }}
        ...
        <div style={{
          ...
          borderRadius: 16, padding: "28px", height: "100%",
          ...
          <p style={{
            ...
            lineHeight: 1.7, flex: 1, marginBottom: 24,
          }}>{p.desc}</p>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <span style={{
              fontSize: 11, fontFamily: "monospace", color: hov ? "#a78bfa" : "rgba(255,255,255,0.25)",
...
function Projects() {
  return (
    <section id="projects" style={{ padding: "120px 5vw", position: "relative" }}>
      <div style={{
        position: "absolute", inset: 0, pointerEvents: "none",
    ...
    <section id="contact" style={{ padding: "120px 5vw 80px" }}>
      <div style={{ maxWidth: 700, margin: "0 auto" }}>
        <FadeIn>
          ...
          <h2 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 800, letterSpacing: "-0.03em", color: "#fff", marginBottom: 16, lineHeight: 1.05 }}>
            Let's work<br/><span style={{ color: "#a78bfa" }}>together</span>
          </h2>
          <p style={{ fontSize: "1.05rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.75, marginBottom: 48, fontWeight: 300 }}>
        ...
        <FadeIn delay={100}>
            ...
            {links.map((l, i) => (
              <a key={i} href={l.href} target="_blank" style={{ textDecoration: "none" }}>
                <div style={{
                  ...
                  <div>
                    <div style={{ fontSize: 11, fontFamily: "monospace", color: "rgba(255,255,255,0.3)", letterSpacing: "0.08em", textTransform: "uppercase" }}>{l.label}</div>
                    <div style={{ fontSize: "0.9rem", color: "rgba(255,255,255,0.7)", marginTop: 2 }}>{l.val}</div>
                  </div>
          ...
          <a href="https://pkjoshi23.github.io/portfolio/Resume.pdf" target="_blank" style={{
            ...
            onMouseEnter={e => { e.currentTarget.style.boxShadow = "0 0 60px rgba(124,58,237,0.55)"; e.currentTarget.style.transform = "translateY(-2px)"; }}
            onMouseLeave={e => { e.currentTarget.style.boxShadow = "0 0 40px rgba(124,58,237,0.35)"; e.currentTarget.style.transform = ""; }}>
            ↓ Download Resume
          </a>
        </FadeIn>
      </div>
